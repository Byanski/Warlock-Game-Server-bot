...
if __name__ == "__main__":
    commands = "cd ~/warlockbot/Warlock-Game-Server-bot && sed -i '/WARLOCK_2FA_SECRET/d' .env && docker-compose down && docker-compose up -d && sleep 10 && docker-compose logs --tail=30"
